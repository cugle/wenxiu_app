 ...
 * 必须按照如下要求设置，才会产生效果
 * 1 添加“x-btn”的class；
 * 2 设置“x-down-theme”属性，该属性值为鼠标点下去时应用的class样式，该样式必须设置
 * 3 设置“x-hover-theme”属性，该属性值为鼠标移过去是应用的class样式，该样式必须设置
 */
( function( $, undefined ) {
	$.fn.x_buttonMarkup = function(){
		$(this).find(".x-btn").buttonMarkup();
	};
	$.fn.buttonMarkup = function() {
		return this.each( function(i) {
			if ( $(this).hasClass( "x-btn" ) && !($(this).hasClass( "x-disabled" )) ) {
				$( this ).bind( {
					"vmousedown": function( event ) {
						var theme = $(this).attr( "x-down-theme" );
						$(this).addClass( theme );
					},
					...
					"vmouseover focus": function( event ) {
						var theme = $(this).attr( "x-hover-theme" );
						$(this).addClass(theme );
					},
...
var dataPropertyName = "virtualMouseBindings",
	...
	eventCaptureSupported = true;//$.support.eventCapture,
	$document = $(document),
	nextTouchID = 1,
	lastTouchID = 0;
...
{
	//alert("mouseEventCallback---"+"v" + event.type);
